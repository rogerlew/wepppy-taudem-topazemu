...
def b(v, encoding='latin-1', encodingErrors='strict'):
    if isinstance(v, str):
...
def u(v, encoding='latin-1', encodingErrors='strict'):
...
class Reader:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.encoding = kwargs.pop('encoding', 'latin-1')
            ...
            if fieldType in ("N", "F"):
                ...
                if isinstance(value, date):
                    ...
                    raise ShapefileException(
                        "Date values must be either a dateutils.date object, a list, a YYYYMMDD string, or a missing value.")
            elif fieldType == 'L':
                # logical: 1 byte - initialized to 0x20 (space) otherwise T or F.
                if value in MISSING:
